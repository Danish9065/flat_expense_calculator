    ...
    return (
        <div className="pb-24 pt-6 px-4 max-w-lg mx-auto min-h-screen">
            ...
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">How to settle up</h2>
            </div>
            <div className="flex space-x-2 mb-4 overflow-x-auto no-scrollbar pb-1">
                {['All', ...Object.keys(CATEGORY_MAP)].map(cat => (
                    <button
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-bold transition-colors ${category === cat
