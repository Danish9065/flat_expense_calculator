        ...
        <main id="calculation-report" className="calculation-report mx-auto max-w-4xl px-4 py-8 sm:px-8 md:px-12 md:py-12">
          {!report && !loadError ? (
            ...
            <>
              ...
              <section className="report-section border-t border-black/10 py-10">
                <div className="mb-6"><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#9c3f24]">Audit details</p><h2 className="text-2xl font-black">Every expense and assigned share</h2><p className="mt-2 text-sm text-[#66736c]">Rounding is stored in paise. When an amount cannot split evenly, extra paise are distributed one per member, starting with the payer.</p></div>
              ...
              <section className="report-section border-t border-black/10 py-10">
                <div className="mb-6"><h2 className="text-2xl font-black">Payments already recorded</h2><p className="mt-2 text-sm text-[#66736c]">{category === 'All' ? 'These payments reduce what the payer owes and reduce what the receiver is due.' : 'Payments are excluded from category-only views because a payment is recorded for the whole group, not for one category.'}</p></div>
